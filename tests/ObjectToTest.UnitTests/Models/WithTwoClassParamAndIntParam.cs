namespace ObjectToTest.UnitTests.Models
{
    ...
    {
        private readonly int _intParam; public WithTwoClassParamAndIntParam(WithClassParam withClassParam, WithClassAndIntParams withClassAndIntParams, int intParam)
        {
